        ...
        else if (get_eel_mode)
        {
            ...
            if (TRIANGLE && !last_TRIANGLE)
            {
                ...
                if(triangle_count % 4 == 1)
                {
                    ...
                    data_[16] = 40; // ハンドアームの内、ワークを掴むサーボの開く角度に設定。必要に応じて調整してください
                }
                else if (triangle_count % 4 == 2)
                {
                    ...
                    data_[16] = 40; // ハンドアームの内、ワークを掴むサーボの角度に設定。必要に応じて調整してください
                }
                ...
                else if (triangle_count % 4 == 0)
                {
                    ...
                    data_[9] = 0; // ハンドアームの内、ワークを掴むサーボの角度に設定。必要に応じて調整してください
                    data_[10] = 0; // ハンドアームの内、ワークを掴むサーボの角度に設定。必要に応じて調整してください
                    data_[16] = 0; // ハンドアームの内、ワークを掴むサーボの角度に設定。必要に応じて調整してください
                }
