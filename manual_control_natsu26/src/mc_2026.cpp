...
//            y=0    y=1    y=2
//     x=0  (0,0)  (0,1)  (0,2)   ← 起動時のカーソルは [0][0]
//     x=1  [欠]   (1,1)  [欠]
//     x=2  (2,0)  (2,1)  (2,2)
// =================================================================
// ヨー角(横？)
static const int kYawPreset[3][3] = {
    { 78,  72, 57}, // x=0列: [0][0]が初期位置
    {  0, 228,   0}, // x=1列: [1][0],[1][2]は欠番
    {225, 180, 200}, // x=2列
};

// ピッチ角(縦？)
static const int kPitchPreset[3][3] = {
    {90, 156, 108}, // x=0列: [0][0]が初期位置
    {  0, 114,   0}, // x=1列: [1][0],[1][2]は欠番
    {200, 160, 120}, // x=2列
};

// 射出速度
static const int kInjectionSpeedPreset[3][3] = {
    {57, 100, 140}, // x=0列: [0][0]=G0(手前左), [0][1]=B0(中央左), [0][2]=B4(奥左)
    {-150, 125, -150}, // x=1列: [1][1]=B1(中央)のみ有効。[1][0],[1][2]は欠番(既定値)
    {110, 140, 180}, // x=2列: [2][0]=B3(手前右), [2][1]=B2(中央右), [2][2]=G1(奥右)
};
